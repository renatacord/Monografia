...
O método simplex proposto por \citeonline{Dan} é utilizado para a resolução do modelo de programação linear. É um dos métodos mais conhecidos e eficientes para resolver problemas de programação linear. Foi implantado comercialmente há mais de 40 anos e atualmente está presente em softwares comerciais tais como CPLEX e LINGO. 
