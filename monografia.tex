...
\usepackage{multirow}
\usepackage{booktabs}
\usepackage[pdfborder={0 0 0},breaklinks=true]{hyperref} % http://www.tug.org/applications/hyperref/manual.html
...
%--------------------------------- Informações ---------------------------------
\newcommand{\meutitulo}{Um método de classificação de dados utilizando programação linear}
\begin{document}
